...
import com.example.projectuts.databinding.FragmentFBmiBinding
...
class fBmi : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentFBmiBinding.inflate(layoutInflater)
    ...
    companion object {
         ...
         * @return A new instance of fragment f_bmi.
         */
